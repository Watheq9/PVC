...
from RankZephyr.data import DataWriter, Request, Result
from RankZephyr.rankllm import PromptMode, RankLLM
from RankZephyr.listwise import RankListwiseOSLLM, SafeOpenai
from RankZephyr.pointwise.monot5 import MonoT5
...
class Reranker:
    ...
    def write_rerank_results(
        ...
        **kwargs,
        ...
        result_file_name = (
            f"{rerank_results_dirname}/{retrieval_method_name}.tsv"
        )
